...
### Cost Estimate
kwh_rate        = 0.12  # Rate in currency_type to calculate cost to run job --CHANGED--
...
gpio_buzz = 11	  # Buzzer connected to GPIO11 Pin 23
...
sim_p_heat     = 2300.0 # W    heating power of oven --CHANGED POWER--
